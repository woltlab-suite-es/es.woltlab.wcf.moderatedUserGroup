# WoltLab Suite Core: Moderated User Groups en Español
Idioma español para **WoltLab Suite Core: Moderated User Groups** desarrollado por [WoltLab GmbH](https://github.com/WoltLab).
